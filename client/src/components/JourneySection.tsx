...
import { Trophy, Code2, Flame, Target, TrendingUp, Star, Cpu } from "lucide-react";
...
const milestones: MilestoneCard[] = [
  { icon: <Code2 size={18} />,     value: "100+",    label: "Rated Contests",     sub: "Codeforces",           color: "indigo"  },
  { icon: <Flame size={18} />,     value: "1500+",   label: "Problems Solved",    sub: "across platforms",     color: "amber"   },
  { icon: <Target size={18} />,    value: "Solid",  label: "Problem Solving",    sub: "Consistency",          color: "emerald" },
...
const contestLog: ContestRow[] = [
  ...
  { period: "2024",         activity: "Shipped first production-grade app",         outcome: "Bridged CP skills with real-world engineering" },
  { period: "2025",         activity: "100+ contests & Deep Dive into AI",          outcome: "Mastered LLM agents and multi-agent workflows" },
];
...
function MilestoneCard({ card, index }: { card: MilestoneCard; index: number }) {
  ...
  return (
    <motion.div
      ...
      className={`group relative rounded-2xl border ${c.border} bg-gray-50 dark:bg-[#111827] p-5 text-center transition-all duration-300 ${c.glow}`}
    >
      ...
      <div className="mt-0.5 text-sm font-semibold text-gray-900 dark:text-white">{card.label}</div>
...
export default function JourneySection() {
  ...
  return (
    <section id="journey" className="relative bg-white dark:bg-[#0B0F19] py-20 transition-colors duration-300">
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
          ...
          >
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                <h3 className="text-base font-bold text-gray-900 dark:text-white">Competitive Programming</h3>
            ...
            <p className="text-sm leading-relaxed text-gray-500">
              100+ rated contests forces a specific mental discipline: read fast, model the problem correctly,
          ...
          >
            {/* GenAI card */}
            <div className="relative overflow-hidden rounded-2xl border border-indigo-500/20 bg-gray-50 dark:bg-[#111827] p-6 text-center shadow-sm">
              <div className="mx-auto mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-500/10 text-indigo-400">
                <Cpu size={18} />
              </div>
              <h3 className="mb-2 text-base font-bold text-gray-900 dark:text-white">AI & Agentic Systems</h3>
              <p className="text-sm leading-relaxed text-gray-500">
                Building the future of software with Generative AI. Specialized in LangChain
                and LangGraph for complex, stateful multi-agent orchestrations.
              </p>
            </div>

            {/* Achievement signal */}
            <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/4 p-5 shadow-sm">
              <div className="mb-2 flex items-center gap-2 text-emerald-400">
                <Trophy size={14} />
                <span className="text-xs font-bold uppercase tracking-widest">Signal</span>
              </div>
              <p className="text-sm leading-relaxed text-gray-500">
                Consistent track record in competitive programming provides a high-signal
                verification of problem-solving ability and code quality for production systems.
              </p>
            </div>
          </motion.div>
        </div>
